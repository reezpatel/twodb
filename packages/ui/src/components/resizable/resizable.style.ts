...
/* Global (not scoped): the panel/handle elements are rendered by
   react-resizable-panels, so scoped selectors cannot reach them. */
export const resizableStyles = css.global`
  .tw-resizable {
    width: 100%;
    height: 100%;
    min-width: 0;
