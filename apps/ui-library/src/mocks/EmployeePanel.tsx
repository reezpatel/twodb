...
const COMP = [
  { label: "Pay rate", value: "$44/hour", from: "From 11/21/2025", current: true },
  { label: "Pay rate", value: "$41/hour", from: "From 07/11/2025", current: false },
  { label: "Billable rate", value: "$45", from: "From 11/21/2025", current: true },
  { label: "Billable rate", value: "$40", from: "From 07/11/2025", current: false },
];
              ...
              <div key={n.id} className="mock-emp__note">
                <div className="mock-emp__note-head">
                  ...
                  <Menu
                    ...
                    trigger={<IconButton size="sm" label={`Options for note by ${n.author}`} icon={<MoreHorizontal />} />}
                  >
