...
import { Building2, FileText, Link2, Mail, MapPin, Phone } from "lucide-react";
...
const ROWS: DocRow[] = [
	{
		id: "r1",
		docType: "Aerodynamic Aluminum Bag",
		product: "Awesome Bronze",
		file: null,
		expires: null,
		template: null,
	},
	...
	{
		id: "r3",
		docType: "Awesome Bronze Shirt",
		product: "Awesome Silk Clock",
		file: "shirt-image-23980.img",
		expires: "2026-08-19",
		template: null,
	},
	{
	...
	{
		id: "r9",
		docType: "Quality Manual v4",
		product: "Awesome Bronze",
		file: "quality-manual.pdf",
		expires: "2026-09-24",
		template: "manual-template.pdf",
	},
	{
		id: "r10",
		docType: "Safety Checklist",
		product: "Silk Clock Pro",
		file: "checklist-2026.pdf",
		expires: "2026-07-12",
		template: null,
	},
	{
		id: "r11",
		docType: "Weld Inspection ISO 3834",
		product: "Awesome Bronze",
		file: "weld-report.pdf",
		expires: "2026-08-11",
		template: null,
	},
	{
		id: "r12",
		docType: "Coating Specification",
		product: "Silk Clock Pro",
		file: null,
		expires: null,
		template: "coating.dotx",
	},
];
...
function ExpirationPill({ iso }: { iso: string | null }) {
	...
	if (state === "expired")
		return <Badge tone="danger">Expired · {label}</Badge>;
			...
			<div className="mock-cp__layout">
				<aside className="mock-cp__side">
					<section className="mock-cp__sec">
						<h4>About</h4>
						<p>
							Leveraging cutting-edge technology and innovative methodologies,
							ScrumRail empowers organizations to optimize their project
							management processes and enhance productivity.
						</p>
					...
					<section className="mock-cp__sec">
						...
						<div className="mock-cp__details">
							<span>
								<Building2 size={14} aria-hidden="true" /> Scrumrail LLC
							</span>
							<span className="tw-tnum">
								<Phone size={14} aria-hidden="true" /> +49 00 00 0000
							</span>
							<span>
								<Mail size={14} aria-hidden="true" /> info@scrumrail.com
							</span>
							<span>
								<MapPin size={14} aria-hidden="true" /> Planetenfeldstraße,
								Dortmund
							</span>
						</div>
					</section>
				...
				<div className="mock-cp__main">
					...
					<DataTable
						...
						rowKey={(r) => r.id}
						searchText={(r) =>
							`${r.docType} ${r.product} ${r.file ?? ""} ${r.template ?? ""}`
						}
