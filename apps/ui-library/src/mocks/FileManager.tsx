...
const FOLDER_FILES: Record<
	string,
	{ name: string; meta: string; icon: "doc" | "img" | "code" }[]
> = {
	product: [
	...
	"digital-art": [
		{ name: "textures.zip", meta: "ZIP · 340 MB · Jul 12", icon: "doc" },
	],
	"src-files": [{ name: "app.tsx", meta: "TSX · 42 KB · Today", icon: "code" }],
	"src-exports": [
		{ name: "bundle.zip", meta: "ZIP · 18 MB · Aug 1", icon: "doc" },
	],
	research: [
		{ name: "interviews.md", meta: "MD · 22 KB · Jun 30", icon: "doc" },
	],
