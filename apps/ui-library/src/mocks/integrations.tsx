...
const CATALOG: Integration[] = [
	// plugins — where twodb talks to other apps
	{
		id: "slack",
		name: "Slack",
		desc: "Send morning briefs and alerts to a channel.",
		icon: <MessageSquare />,
		category: "plugins",
	},
	{
		...
		desc: "Two-way sync for appointments and reminders.",
		icon: <Calendar />,
		category: "plugins",
	},
	{
		id: "whatsapp",
		name: "WhatsApp",
		desc: "Reply to patients and customers from one inbox.",
		icon: <Phone />,
		category: "plugins",
	},
	{
		id: "notion-import",
		name: "Notion Import",
		desc: "Bring existing docs and databases over.",
		icon: <FileText />,
		category: "plugins",
	},
	{
		id: "zapier",
		name: "Zapier",
		desc: "Reach 6,000 apps through existing Zaps.",
		icon: <Blocks />,
		category: "plugins",
	},
	{
		id: "webhook",
		name: "Webhooks",
		desc: "Push events to any URL you control.",
		icon: <Globe />,
		category: "plugins",
	},
	...
	// tools — built-in abilities that need a key or setup
	{
		id: "ocr",
		name: "OCR Scanner",
		desc: "Turn prescriptions and receipts into text.",
		icon: <ScanLine />,
		category: "tools",
	},
	{
		id: "voice",
		name: "Voice Notes",
		desc: "Dictate notes; get them transcribed and filed.",
		icon: <Mic />,
		category: "tools",
	},
	{
		id: "pdf",
		name: "PDF Toolkit",
		desc: "Merge, split, and sign documents in place.",
		icon: <FileDown />,
		category: "tools",
	},
	{
		id: "clipper",
		name: "Web Clipper",
		desc: "Save pages straight into your notebooks.",
		icon: <Paperclip />,
		category: "tools",
	},
	...
	// services — accounts and infrastructure
	{
		id: "razorpay",
		name: "Razorpay",
		desc: "Collect payments and reconcile invoices.",
		icon: <CreditCard />,
		category: "services",
	},
	{
		id: "openai",
		name: "OpenAI",
		desc: "Power the assistant and the app builder.",
		icon: <Brain />,
		category: "services",
	},
	{
		id: "gdrive",
		name: "Google Drive",
		desc: "Attach files without moving them.",
		icon: <HardDrive />,
		category: "services",
	},
	{
		id: "s3",
		name: "S3 Backup",
		desc: "Nightly encrypted backups to your bucket.",
		icon: <Cloud />,
		category: "services",
	},
];
	...
	return (
		<div className="mock-int">
			<header className="mock-int__head">
				<h2>Integrations</h2>
				<p>
					Connect {CATEGORY_LABEL[tab].toLowerCase()} once — twodb keeps them in
					sync and tells you when one needs attention.
				</p>
			</header>
						...
						{connected.map((item) => {
							...
							return (
								<div
									...
									className={
										issue
											? "mock-int__row mock-int__row--issue"
											: "mock-int__row"
									}
								>
