			...
			<div className="plugins-card__body">
				<div className="plugins-card__identity">
					<div>
						...
						<p title={integration.identifier}>{integration.identifier}</p>
					</div>
					<img
						src={placeholderUrl(integration.name)}
						alt=""
						width={72}
						height={72}
					/>
				...
				<div className="plugins-card__actions">
					{integration.connected ? (
						<Button
							variant="ghost"
							size="sm"
							onClick={() => state.openIntegration(integration.identifier)}
						>
							View
						</Button>
					) : null}
