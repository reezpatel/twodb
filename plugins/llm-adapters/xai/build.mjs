...
// registry host), which must be the shell's own
...
const view = await context({
  ...
  target: "es2022",
  jsx: "automatic",
  external: ["react", "react-dom", "react/jsx-runtime", "react/jsx-dev-runtime", "@tanstack/react-query", "@twodb/shared-frontend"],
