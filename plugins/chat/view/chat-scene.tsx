...
import { chatSceneStyles as rawChatSceneStyles } from "./chat-scene.style";
import { useChatScene, type ChatPost } from "./hooks/use-chat-scene";

const chatSceneStyles = rawChatSceneStyles as unknown as string;
...
export function ChatScene() {
	const { channel, setChannel, infoTab, setInfoTab, posts, send } =
		useChatScene(INITIAL_POSTS);
