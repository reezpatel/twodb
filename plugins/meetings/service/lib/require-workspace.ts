...
/**
 * Every meetings route runs inside a workspace. The identity session hook
 * has already authenticated the request; this gate additionally requires the
 * principal to resolve to a workspace the user belongs to. Returns null
 * (after replying) or the workspace id.
 */
